...
The following is a link to the online source repository.
    ...
    http://svn.apache.org/repos/asf/struts/struts1/trunk/apps/faces-example1/
...
The source can be checked out anonymously from SVN with this command:
    ...
    $ svn checkout http://svn.apache.org/repos/asf/struts/struts1/trunk/apps/faces-example1/ struts-faces-example1
...
Everyone can access the Subversion repository via HTTP, but Committers must checkout the Subversion repository via HTTPS.
    ...
    $ svn checkout https://svn.apache.org/repos/asf/struts/struts1/trunk/apps/faces-example1/ struts-faces-example1
