...
-   org.apache.struts:struts-mailreader:war:1.3.10 ![Information](./images/icon_info_sml.gif)
    <table>
    <colgroup>
    <col width="100%" />
    </colgroup>
    <thead>
    <tr class="header">
    <th align="left">Struts Apps - Mailreader</th>
    </tr>
    </thead>
    <tbody>
    <tr class="odd">
    <td align="left"><p><strong>Description:</strong> Apache Struts</p>
    <p><strong>URL:</strong> <a href="http://struts.apache.org/struts-apps/struts-mailreader" class="uri">http://struts.apache.org/struts-apps/struts-mailreader</a></p>
...
**The Apache Software License, Version 2.0:** Commons BeanUtils, Commons Chain, Digester, Logging, Struts Apps - Mailreader, Struts Core, Struts Extras, Struts Mailreader DAO, Struts Taglib, Validator
