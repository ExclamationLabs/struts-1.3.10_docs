...
extends [ImportAttributeTag](../../../../../org/apache/struts/tiles/taglib/ImportAttributeTag.html.md "class in org.apache.struts.tiles.taglib")
...
| **Fields inherited from class org.apache.struts.tiles.taglib.[ImportAttributeTag](../../../../../org/apache/struts/tiles/taglib/ImportAttributeTag.html.md "class in org.apache.struts.tiles.taglib")** |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ` isErrorIgnored`                                                                                                                                                                                    |
...
| **Methods inherited from class org.apache.struts.tiles.taglib.[ImportAttributeTag](../../../../../org/apache/struts/tiles/taglib/ImportAttributeTag.html.md "class in org.apache.struts.tiles.taglib")** |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
