...
Set to `true` to render an `xml:lang` element on the generated .html.md` element. It also causes nested Struts HTML tags (although not JavaServer Faces component tags) to render themselves as xhtml.
