...
If specified, defines the message key to be looked up in the resource bundle specified by `bundle`
...
The session attributes key for the Locale instance to use for looking up the message specified by the `key`
