...
extends [UseAttributeTag](http://struts.apache.org/apidocs/org/apache/struts/tiles/taglib/UseAttributeTag.html.md?is-external=true "class or interface in org.apache.struts.tiles.taglib")
...
| **Fields inherited from class org.apache.struts.tiles.taglib.[UseAttributeTag](http://struts.apache.org/apidocs/org/apache/struts/tiles/taglib/UseAttributeTag.html.md?is-external=true "class or interface in org.apache.struts.tiles.taglib")** |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `isErrorIgnored`                                                                                                                                                                                                                               |
...
| **Methods inherited from class org.apache.struts.tiles.taglib.[UseAttributeTag](http://struts.apache.org/apidocs/org/apache/struts/tiles/taglib/UseAttributeTag.html.md?is-external=true "class or interface in org.apache.struts.tiles.taglib")** |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
