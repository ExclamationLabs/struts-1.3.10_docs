...
extends [NotMatchTag](http://struts.apache.org/apidocs/org/apache/struts/taglib/logic/NotMatchTag.html.md?is-external=true "class or interface in org.apache.struts.taglib.logic")
...
| **Methods inherited from class org.apache.struts.taglib.logic.[NotMatchTag](http://struts.apache.org/apidocs/org/apache/struts/taglib/logic/NotMatchTag.html.md?is-external=true "class or interface in org.apache.struts.taglib.logic")** |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `condition`                                                                                                                                                                                                                             |
