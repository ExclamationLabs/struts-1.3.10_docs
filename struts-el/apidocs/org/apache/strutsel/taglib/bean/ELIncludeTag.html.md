...
extends [IncludeTag](http://struts.apache.org/apidocs/org/apache/struts/taglib/bean/IncludeTag.html.md?is-external=true "class or interface in org.apache.struts.taglib.bean")
...
| **Fields inherited from class org.apache.struts.taglib.bean.[IncludeTag](http://struts.apache.org/apidocs/org/apache/struts/taglib/bean/IncludeTag.html.md?is-external=true "class or interface in org.apache.struts.taglib.bean")** |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| **Methods inherited from class org.apache.struts.taglib.bean.[IncludeTag](http://struts.apache.org/apidocs/org/apache/struts/taglib/bean/IncludeTag.html.md?is-external=true "class or interface in org.apache.struts.taglib.bean")** |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
