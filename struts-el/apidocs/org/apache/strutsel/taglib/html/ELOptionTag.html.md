...
extends [OptionTag](http://struts.apache.org/apidocs/org/apache/struts/taglib.html.md/OptionTag.html?is-external=true "class or interface in org.apache.struts.taglib.html")
...
| **Fields inherited from class org.apache.struts.taglib.html.md.[OptionTag](http://struts.apache.org/apidocs/org/apache/struts/taglib/html/OptionTag.html?is-external=true "class or interface in org.apache.struts.taglib.html")** |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| **Methods inherited from class org.apache.struts.taglib.html.md.[OptionTag](http://struts.apache.org/apidocs/org/apache/struts/taglib/html/OptionTag.html?is-external=true "class or interface in org.apache.struts.taglib.html")**                                                               |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
