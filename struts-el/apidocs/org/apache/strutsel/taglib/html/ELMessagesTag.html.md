...
extends [MessagesTag](http://struts.apache.org/apidocs/org/apache/struts/taglib.html.md/MessagesTag.html?is-external=true "class or interface in org.apache.struts.taglib.html")
...
| **Fields inherited from class org.apache.struts.taglib.html.md.[MessagesTag](http://struts.apache.org/apidocs/org/apache/struts/taglib/html/MessagesTag.html?is-external=true "class or interface in org.apache.struts.taglib.html")** |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| **Methods inherited from class org.apache.struts.taglib.html.md.[MessagesTag](http://struts.apache.org/apidocs/org/apache/struts/taglib/html/MessagesTag.html?is-external=true "class or interface in org.apache.struts.taglib.html")** |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
