...
<td align="left"><a href="class-use/ELSelectTag.html.md"><strong>Use</strong></a> </td>
...
<tr class="even">
<td align="left"> <a href="../../../../../org/apache/strutsel/taglib.html.md/ELRewriteTagBeanInfo.html" title="class in org.apache.strutsel.taglib.html"><strong>PREV CLASS</strong></a>   <a href="../../../../../org/apache/strutsel/taglib/html/ELSelectTagBeanInfo.html" title="class in org.apache.strutsel.taglib.html"><strong>NEXT CLASS</strong></a></td>
<td align="left"><a href="../../../../../index.html.md?org/apache/strutsel/taglib/html/ELSelectTag.html"><strong>FRAMES</strong></a>    <a href="ELSelectTag.html"><strong>NO FRAMES</strong></a>    
<a href="../../../../../allclasses-noframe.html.md"><strong>All Classes</strong></a></td>
</tr>
<tr class="odd">
<td align="left">SUMMARY: NESTED | <a href="#fields_inherited_from_class_org.apache.struts.taglib.html.md.SelectTag">FIELD</a> | <a href="#constructor_summary">CONSTR</a> | <a href="#method_summary">METHOD</a></td>
...
------------------------------------------------------------------------
    ...
    public class ELSelectTag

extends [SelectTag](http://struts.apache.org/apidocs/org/apache/struts/taglib.html.md/SelectTag.html?is-external=true "class or interface in org.apache.struts.taglib.html")
...
This class is a subclass of the class `org.apache.struts.taglib.html.md.SelectTag` which provides most of the described functionality. This subclass allows all attribute values to be specified as expressions utilizing the JavaServer Pages Standard Library expression language.

**Version:**  
$Rev: 479635 $

**See Also:**  
[Serialized Form](../../../../../serialized-form.html.md#org.apache.strutsel.taglib.html.ELSelectTag)
...
 <span id="fields_inherited_from_class_org.apache.struts.taglib.html.md.SelectTag"></span>

| **Fields inherited from class org.apache.struts.taglib.html.md.[SelectTag](http://struts.apache.org/apidocs/org/apache/struts/taglib/html/SelectTag.html?is-external=true "class or interface in org.apache.struts.taglib.html")** |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
` setMultipleExpr(String multipleExpr)`
...
 <span id="methods_inherited_from_class_org.apache.struts.taglib.html.md.SelectTag"></span>

| **Methods inherited from class org.apache.struts.taglib.html.md.[SelectTag](http://struts.apache.org/apidocs/org/apache/struts/taglib/html/SelectTag.html?is-external=true "class or interface in org.apache.struts.taglib.html")** |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `doAfterBody, doEndTag, getMultiple, getName, getProperty, getSize, getValue, isMatched, prepareName, renderSelectStartElement, setMultiple, setName, setProperty, setSize, setValue`                                            |
