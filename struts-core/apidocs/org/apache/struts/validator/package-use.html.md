...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **[**BeanValidatorForm**](../../../../org/apache/struts/validator/class-use/BeanValidatorForm.html.md#org.apache.struts.validator)**                                                                          
            Struts *validator* `ActionForm` backed by either a `DynaBean` or POJO JavaBean.                                                                                                                  |
| **[**ValidatorForm**](../../../../org/apache/struts/validator/class-use/ValidatorForm.html.md#org.apache.struts.validator)**                                                                                  
